...
function appendVideoThumb(v, i) {	
	...
	thumb.prop('src', '/api/thumb?url=' + encodeURIComponent('http://img.youtube.com/vi/' + v.url.substring(v.url.length,v.url.length-11) + '/0.jpg'));
	desc.text(v.title);
